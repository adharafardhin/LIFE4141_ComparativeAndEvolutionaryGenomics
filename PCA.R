...
## Part 1: Basic Genetic Structure Assessment

### This R script performs population genetic analysis using Principal Component Analysis (PCA)

# Setting the warning level to 1
options(warn=1)
...
# Define a function for conversion from vcfR object to genlight in tetraploids and hexaploids
...
# Visualizing populations with distinct colors on a PCA plot
# Use a custom color palette (funky) to color code populations on a PCA scatter plot.
col <- funky(10)
# Adjusting parameters for better visualization.
